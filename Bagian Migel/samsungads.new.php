...
if(isset($_GET['logout'])) {
		...
		header('location: ../Bagian Migel/samsungads.new.php');
}
...
<p><img src = "https://1000logos.net/wp-content/uploads/2017/06/emblem-Samsung.jpg" alt= "samsung" width="300" height="100" ></p>
<p> 
	<center> 
		<div id="banner">
			<figure>
				<img src="https://eraspace.com/pub/media/kemana/bannerslider/banner/image/s/l/slider_banner_samsung_galaxy_a31_1600x542px_6_mei_2020_.jpg" alt="">
				<img src="https://eraspace.com/pub/media/kemana/bannerslider/banner/image/s/l/slider_banner_samsung_galaxy_a31_1600x542px_6_mei_2020_.jpg" alt="">
				<img src="https://eraspace.com/pub/media/kemana/bannerslider/banner/image/s/l/slider_banner_samsung_galaxy_a31_1600x542px_6_mei_2020_.jpg" alt="">
				<img src="https://eraspace.com/pub/media/kemana/bannerslider/banner/image/s/l/slider_banner_samsung_galaxy_a31_1600x542px_6_mei_2020_.jpg" alt="">
				<img src="https://eraspace.com/pub/media/kemana/bannerslider/banner/image/s/l/slider_banner_samsung_galaxy_a31_1600x542px_6_mei_2020_.jpg" alt="">
...
<p>
<center>
	<div style="margin-top:-500px;"><p1> Pilih Smartphone Anda  <p1></div>
</center>
</p>
<br><br>
...
<li type="none"> <img src ="https://ecs7.tokopedia.net/img/cache/700/product-1/2020/2/13/48435890/48435890_17433489-391c-4128-9a77-73be0f2c12b8_710_710" style="position: relative; left: -300px;" alt= "samsung" width="300" height="300"> <p>
	<p style="position: relative; left: -300px;">Samsung Galaxy S20 Ultra <p>
	<p style="position: relative; left: -300px;">Spesifikasi :<p>
	<p style="position: relative; left: -300px;">Ram : 6 GB <p>
	<p style="position: relative; left: -300px;">Screen Display : 1080 HD<p>
	<p style="position: relative; left: -300px;"> Harga : Rp 20.999.000 - Rp 21.999.000<p>

 </li>
 
 <li type="none"> <img src ="https://images.samsung.com/is/image/samsung/id-galaxy-m51-m515f-sm-m515fzwexid-frontwhite-thumb-295901790?$240_240_PNG$" style="position: relative; left: -200px;" alt= "samsung" width="300" height="300"> <p>
	<p style="position: relative; left: -200px;">Samsung M51 <p>
	<p style="position: relative; left: -200px;">Spesifikasi :<p>
	<p style="position: relative; left: -200px;">Ram : 8 GB <p>
	<p style="position: relative; left: -200px;">Screen Display : 1080 HD<p>
	<p style="position: relative; left: -200px;"> Harga : Rp 5.499.000 <p>

 </li>
 
 
<li type="none"> <img src ="https://images-na.ssl-images-amazon.com/images/I/71LhAERRPaL._SX679_.jpg" style="position: relative; right: 100px;" alt= "samsung" width="300" height="300"><p>
	<p style="position: relative; right: 100px;" > Samsung Fold <p>
	<p style="position: relative; right: 100px;">Spesifikasi :<p>
	<p style="position: relative; right: 100px;">Ram : 8 GB <p>
	<p style="position: relative; right: 100px;">Screen Display : 1080 HD<p>
	<p style="position: relative; right: 100px;"> Harga : Rp 33.799.000<p>

</li>

<li type="none"> <img src ="https://images.samsung.com/uk/smartphones/galaxy-z-flip/buy/carousel/mobile/black-purple/0-Bloom-Black-Purple-Family-1-img.jpg" style="position: relative; right: 10px;" alt= "samsung" width="300" height="300"> <p>
	<p style="position: relative; right: 10px;" > Samsung Z flip <p>
	<p style="position: relative; right: 10px;">Spesifikasi :<p>
	<p style="position: relative; right: 10px;">Ram : 12 GB <p>
	<p style="position: relative; right: 10px;">Screen Display : 1080 HD<p>
	<p style="position: relative; right: 10px;"> Harga : Rp 20.999.000<p>
