...
if(isset($_GET['logout'])) {
		...
		header('location: ../Bagian Tius/wirelesschargerProducts1.php');
}
...
ul.no-bullets {
  ...
  <title>Wireless Chargers | SI Gadget</title>
...
<p style="text-align:center; font-size: 15px; position: relative; left: -365px;">Home / Wireless Charger/Mophie Powerstation Plus Wireless 8k PD </p>
<hr>
...
<!-----single product details------>
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="(WIRELESS%20CHARGER)1.jpg" width="100%" id="ProductImg">
			</div>
			<div class="col-2">
			<h1>Mophie Powerstation <br> Plus Wireless 8k PD</h1>
			<h4 id="demo">Rp 1.396.647,45</h4>
				...
				<br>
							...
							<a href="../Bagian David/Keranjang Belanja/keranjangbelanjaMophiePowerstation.php" class="btn-cart">Beli</a>
							<br><br>
							<h3>Detail Produk</h3>
							<p>mophie powerstation plus baterai universal nirkabel 8K PD dengan kabel Lightning terintegrasi dan daya hingga 18W mengisi daya iPhone Anda pada kecepatan tercepat yang dapat didukungnya. Selain itu, dengan tiga opsi pengisian daya — termasuk bantalan pengisi daya nirkabel — Anda dapat mengisi daya hingga tiga perangkat Apple secara bersamaan. Ini juga mengisi ulang dengan kabel Lightning, jadi tidak perlu membawa kabel yang berbeda.</p>
							<br>
							...
							<table style="width:200%">
								  <tr>
									<td>Teknis</td>
									<td>Fitur Lain: Pengisian</td>
                                </tr>
									  <tr>
										<td></td>
										<td>Panjang Kabel: 5,5 inci / 14,0 cm</td>
									  </tr>
										...
										<td>Koneksi: Petir</td>
										  ...
										  <tr>
											...
											<td>Sumber Daya: Baterai</td>
											  ...
											  <tr>
												<td></td>
												<td>Baterai: Built-in Rechargeable, Baterai lithium-ion built-in yang dapat diisi ulang,<br> lithium-ion yang dapat diisi ulang</td>
											  </tr>
												  <tr>
													<td></td>
													<td>Tinggi: 5,91 inci / 15 cm</td>
												 
															</tr>
                                  <tr>
													<td></td>
													<td>Panjang: 5,91 inci / 15 cm</td>
												 
															</tr>
                                <tr>
													<td></td>
													<td>Lebar: 2,83 inci / 7,2 cm</td>
												 
															</tr><tr>
													<td></td>
													<td>Kedalaman: 0,75 inci / 1,9 cm</td>
												 
															</tr><tr>
													<td></td>
													<td>Berat: 8,11 oz. / 230 g</td>
...
<div class="col-4" onclick="location.href='wirelesschargerProducts1.php';">
	...
	<div class="col-4" onclick="location.href='wirelesschargerProducts1.php';">
		<img src="(WIRELESS%20CHARGER)3.jpg">
	...
	<div class="col-4" onclick="location.href='wirelesschargerProducts1.php';">
		...
		<img src=(WIRELESS%20CHARGER)5.jpg>
