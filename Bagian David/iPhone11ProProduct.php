...
if(isset($_GET['logout'])) {
		...
		header('location: iPhone11ProProduct.php');
}
																					...
																					<li><a class="dropdown" href="../Bagian Migel/realme.php">Realme</a></li>
																															...
																															if(empty($_SESSION['account_username'])) {
																																echo "<a href='Bagian David/account.php'>Login</a>";
																																	...
																																	echo "<form method='GET' action='iPhone11ProProduct.php' enctype='multipart/form-data'>";
...
<!-----single product details------>
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-midnight-green.png" width="100%" id="ProductImg">
			</div>
			<div class="col-2">
			<h1>iPhone 11 Pro</h1>
			<h4 id="demo">Rp. 16.999.000</h4>
				...
				<select id="mySelect" onchange="myFunction()">
					<option value="16.999.000">64 GB</option>
							...
							<table style="width:167%">
								  <tr>
									...
									<td>Layar Super Retina XDR</td>
									  ...
									  <tr>
										<td></td>
										<td>Layar OLED Multi-Touch sepenuhnya 5,8 inci (diagonal)</td>
									  </tr>
											<tr>
										<td></td>
										<td>Layar HDR</td>
...
<script>
function changeGold() {
ProductImg.src = "Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-gold.png";
}

function changeMidnightGreen() {
ProductImg.src = "Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-midnight-green.png";
}

function changeSilver() {
ProductImg.src = "Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-silver.png";
}

function changeSpaceGrey() {
ProductImg.src = "Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-space-grey.png";
}
</script>

<script>
function myFunction() {
  var harga = document.getElementById("mySelect").value;
  document.getElementById("demo").innerHTML = "Rp. " + harga;
}
</script>
