...
if(isset($_GET['logout'])) {
		...
		header('location: iPhone11ProMaxProduct.php');
}
...
ul.no-bullets {
  ...
  <title>iPhone 11 Pro Max | SI Gadget</title>
																					...
																					<li><a class="dropdown" href="../Bagian Migel/realme.php">Realme</a></li>
																															...
																															if(empty($_SESSION['account_username'])) {
																																echo "<a href='Bagian David/account.php'>Login</a>";
																																	...
																																	echo "<form method='GET' action='iPhone11ProMaxProduct.php' enctype='multipart/form-data'>";
...
<p style="text-align:center; font-size: 15px; position: relative; left: -545px;">Home / iPhone 11 Pro</p>
<hr>
...
<!-----single product details------>
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-max-midnight-green.png" width="100%" id="ProductImg">
			</div>
			<div class="col-2">
			<h1>iPhone 11 Pro Max</h1>
			<h4 id="demo">Rp. 18.999.000</h4>
				<button class="btn" style="background-color: #fbdfb4;" width="100%" onclick="changeGold()"></button>
				<button class="btn" style="background-color: #004953;" width="100%" onclick="changeMidnightGreen()"></button>
				...
				<select id="mySelect" onchange="myFunction()">
					<option value="18.999.000">64 GB</option>
					<option value="22.999.000">256 GB</option>
					<option value="26.999.000">512 GB</option>
				</select>
				...
				<br>
							...
							<a href="../Bagian David/Keranjang Belanja/keranjangbelanjaiPhone11ProMax.php" class="btn-cart">Beli</a>
							<br><br>
							<h3>Detail Produk</h3>
									...
									<td>Layar Super Retina XDR</td>
									  ...
									  <tr>
										...
										<td>Layar HDR</td>
										  ...
										  <tr>
											<td></td>
											<td>Resolusi 2688 x 1242 piksel pada 458 ppi</td>
										  </tr>
											  <tr>
												<td></td>
												<td>Rasio kontras 2.000.000:1 (umum)</td>
											  </tr>
												  <tr>
													<td></td>
														...
														<td>Haptic Touch</td>
															...
															<hr><br>
																...
																<table style="width:116%">
																		...
																		<td>Level IP68 (kedalaman maksimum 4 meter hingga selama 30 menit) menurut standar IEC 60529</td>
																	  </tr>														
																</table>
																<hr><br>
																...
																<hr><br>
																		...
																		<tr>
																		<td>Kamera</td>
																		<td>Tiga kamera 12 MP Ultra Wide, Wide, dan Telefoto</td>
																	  </tr>
																	  <tr>
																		<td></td>
																			...
																			<td>Telefoto: bukaan ƒ/2.0</td>
																			  ...
																			  <tr>
																				...
																				<td>Penstabilan gambar optik ganda</td>
																					...
																					<tr>
																					<td></td>
																					<td>Zoom optik 2x memperbesar, zoom optik 2x memperkecil; zoom digital 10x</td>
																					</tr>
																						<tr>
																						<td></td>
																			...
																			<table style="width:149%">
																					...
																					<td>Mampu merekam video 4K pada kecepatan 24 fps, 30 fps, atau 60 fps</td>
																						...
																						<td>Mampu merekam video HD 1080p pada kecepatan 30 fps atau 60 fps</td>
																							...
																							<tr>
																							<td></td>
																							<td>Rentang dinamis yang diperluas untuk video hingga kecepatan 60 fps</td>
																							</tr>
																							<tr>
																							<td></td>
																							...
																							<td></td>
																							<td>Zoom optik 2x memperbesar, zoom optik 2x memperkecil; zoom digital hingga 6x</td>
																							</tr><tr>
																							<td></td>
																							<td>Zoom audio</td>
																							</tr><tr>
																				  ...
																				  <table style="width:115%">
																					...
																					<td>Face ID</td>
																						...
																						<tr>
																					<td></td>
																					<td>Hadir berkat kamera TrueDepth untuk pengenalan wajahe</td>
																				  </tr>
																				</table>
																				<hr><br>
																				...
																				<table style="width:66%">
																					...
																					<td>Pemutaran audio spasial</td>
																				  </tr>
																						<tr>
																					<td></td>
																					<td>Mendukung Dolby Atmos</td>
																				  </tr>
																				</table>
																				<hr><br>
																				...
																				<table style="width:130%">
																					...
																					<td>Dengan waktu pakai hingga 4 jam lebih lama dibanding iPhone XS</td>
																				  </tr>
																						<tr>
																						<td></td>
...
<script>
function changeGold() {
ProductImg.src = "Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-max-gold.png";
}

function changeMidnightGreen() {
ProductImg.src = "Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-max-midnight-green.png";
}

function changeSilver() {
ProductImg.src = "Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-max-silver.png";
}

function changeSpaceGrey() {
ProductImg.src = "Gallery/iPhone/iPhone 11 Pro/iphone-11-pro-max-space-grey.png";
}
</script>
