...
if(isset($_GET['logout'])) {
		...
		header('location: iPhone11Product.php');
}
																					...
																					<li><a class="dropdown" href="../Bagian Migel/realme.php">Realme</a></li>
																															...
																															if(empty($_SESSION['account_username'])) {
																																echo "<a href='../Bagian David/account.php'>Login</a>";
																																	...
																																	echo "<form method='GET' action='iPhone11Product.php' enctype='multipart/form-data'>";
...
<p style="text-align:center; font-size: 15px; position: relative; left: -545px;">Home / iPhone 11</p>
<hr>
...
<!-----single product details------>
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="Gallery/iPhone/iPhone 11/apple_iphone_11_black.png" width="100%" id="ProductImg">
			</div>
			<div class="col-2">
			<h1>iPhone 11</h1>
			<h4 id="demo">Rp. 11.999.000</h4>
				<button class="btn" style="background-color: #B9DED2;" width="100%" onclick="changeGreen()"></button>
				<button class="btn" style="background-color: #CCB9E0;" width="100%" onclick="changePurple()"></button>
				<button class="btn" style="background-color: #F2F2F2;" width="100%" onclick="changeWhite()"></button>
				<button class="btn" style="background-color: #111111;" width="100%" onclick="changeBlack()"></button>
				<button class="btn" style="background-color: #DB3030;" width="100%" onclick="changeRED()"></button>
				<button class="btn" style="background-color: #F1DF5B;" width="100%" onclick="changeYellow()"></button>
				<br>
				<select id="mySelect" onchange="myFunction()">
					<option value="11.999.000">64 GB</option>
					<option value="12.499.000">128 GB</option>
					<option value="14.999.000">256 GB</option>
				</select>
				...
				<br>
							...
							<br><br>
							<h3>Detail Produk</h3>
							<p>Sistem kamera ganda baru merekam lebih banyak lagi hal yang Anda lihat dan sukai. Chip paling cepat yang pernah ada di ponsel pintar dan kekuatan baterai sepanjang hari memungkinkan Anda melakukan lebih banyak hal tanpa perlu sering mengisi daya. Dan kualitas video terbaik di ponsel pintar, jadi kenangan Anda terlihat lebih baik daripada sebelumnya. Layar Liquid Retina sepenuhnya 6,1 inci yang begitu penuh warna. Desain layar sepenuhnya yang begitu nyata menjadikan segalanya terlihat mengagumkan. Dengan material aluminium sekelas industri dirgantara yang kuat dan tahan lama. Membuat iPhone 11 begitu mengagumkan dikelasnya. Dengan Chip A13 Bionic yang begitu andal, semua yang Anda lakukan begitu cepat dan lancar dan juga mampu bekerja dengan cara yang paling menghemat daya, sehingga baterai lebih tahan lama.</p>
							<br>
							...
							<table style="width:220%">
								  <tr>
									<td>Tipe Layar</td>
									<td>Layar Liquid Retina HD</td>
								  </tr>
									  <tr>
										<td></td>
										<td>Layar LCD Multi-Touch sepenuhnya 6,1 inci (diagonal) dengan teknologi IPS</td>
									  </tr>
										  <tr>
											<td></td>
											<td>Resolusi 1792 x 828 piksel pada 326 ppi</td>
										  </tr>
											  <tr>
												<td></td>
												<td>Rasio kontras 1400:1 (umum)</td>
											  </tr>
												  <tr>
													<td></td>
													...
													<td>Layar warna luas (P3)</td>
														...
														<td>Haptic Touch</td>
															...
															<tr>
															<td></td>
															<td>Kecerahan maks 800 nit (umum)</td>
															</tr>
															</table>
															<hr><br>
															...
															<hr><br>
																...
																<table style="width:195%">
																		...
																		<td>A13 Bionic</td>
																			...
																			<tr>
																					<td></td>
																					<td>Neural Engine generasi ketiga</td>
																				  </tr>
																</table>
																<hr><br>
																		...
																		<tr>
																		<td>Kamera</td>
																		<td>Kamera ganda Ultra Wide dan Wide 12 MP</td>
																	  </tr>
																	  <tr>
																		<td></td>
																		<td>Ultra Wide: bukaan ƒ/2.4</td>
																	  </tr>
																		  <tr>
																			<td></td>
																		  ...
																		  <tr>
																			  ...
																			  <tr>
																				<td></td>
																				<td>Penyesuaian Otomatis</td>
																			  </tr>
																			  <tr>
																				<td></td>
																				<td>Penstabilan gambar optik</td>
																			  </tr>
																				<tr>
																				<td></td>
																				<td>Zoom optik 2x memperkecil; digital hingga 5x</td>
																				</tr>
																					<tr>
																					<td></td>
																					<td>Flash True Tone lebih terang dengan Slow Sync</td>
																					</tr>
																						<tr>
																						<td></td>
																						<td>Mode Potret dengan bokeh yang disempurnakan dan Depth Control</td>
																							...
																							<tr>
																							<td></td>
																							<td>Smart HDR generasi berikutnya untuk foto</td>
																							</tr>
																						</table>
																						<hr><br>
																			...
																			<table style="width:139%">
																				  ...
																				  <hr><br>
																					...
																					<td>Kamera TrueDepth</td>
																						...
																						<td>Foto 12 MP</td>
																							...
																							<td></td>
																							<td>Penstabilan video sinematik (4K, 1080p, dan 720p)</td>
																							</tr><tr>
																							<td></td>
																							<td>Mampu merekam video 4K pada kecepatan 24 fps, 30 fps, atau 60 fps</td>
																							</tr><tr>
																							...
																							<td></td>
																							<td>Dukungan video slo-mo untuk 1080p pada kecepatan 120 fps</td>
																							</tr><tr>
																							<td></td>
																				...
																				<table style="width:95%">
																					...
																					<td>Mendukung Dolby Vision dan konten HDR10</td>
																				  </tr>
																				</table>
																				<hr><br>
																				...
																				<table style="width:131%">
																					...
																					<td>Dengan waktu pakai hingga 1 jam lebih lama dibanding iPhone XR</td>
																				  </tr>
																						<tr>
																						<td></td>
...
ProductImg.src = "Gallery/iPhone/iPhone 11/apple_iphone_11_green.png";
}

function changePurple() {
ProductImg.src = "Gallery/iPhone/iPhone 11/apple_iphone_11_purple.png";
}

function changeWhite() {
ProductImg.src = "Gallery/iPhone/iPhone 11/apple_iphone_11_white.png";
}

function changeBlack() {
ProductImg.src = "Gallery/iPhone/iPhone 11/apple_iphone_11_black.png";
}

function changeRED() {
ProductImg.src = "Gallery/iPhone/iPhone 11/apple_iphone_11_red.png";
}

function changeYellow() {
ProductImg.src = "Gallery/iPhone/iPhone 11/apple_iphone_11_yellow.png";
}
</script>
