...
if(isset($_GET['logout'])) {
		...
		header('location: iPhone11ProProducts.php');
}
...
.col-4:hover {
  ...
  <title>iPhone 11 Pro Series | SI Gadget</title>
																					...
																					<li><a class="dropdown" href="../Bagian Migel/realme.php">Realme</a></li>
																															...
																															if(empty($_SESSION['account_username'])) {
																																echo "<a href='Bagian David/account.php'>Login</a>";
																																	...
																																	echo "<form method='GET' action='iPhone11ProProducts.php' enctype='multipart/form-data'>";
...
<!-----featured products------>
<h2 style="text-align: center;">iPhone 11 Pro</h2>
<hr>
