...
if(isset($_GET['logout'])) {
		...
		header('location: iPhoneSEProduct.php');
}
...
<!-----single product details------>
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="Gallery/iPhone/iPhone SE/iPhoneSEDisplay.png" width="100%" id="ProductImg">
			</div>
			<div class="col-2">
			<h1>iPhone SE 2nd generation</h1>
			<h4 id="demo">Rp. 7.999.000</h4>
				...
				<select id="mySelect" onchange="myFunction()">
					<option value="7.999.000">64 GB</option>
					<option value="8.999.000">128 GB</option>
					<option value="10.999.000">256 GB</option>
				</select>
				...
				<br>
							...
							<a href="../Bagian David/Keranjang Belanja/keranjangbelanjaiPhoneSE.php" class="btn-cart">Beli</a>
							<br><br>
							<h3>Detail Produk</h3>
							<p>iPhone SE adalah iPhone 4,7 inci paling canggih yang pernah ada.
							(1) Dilengkapi A13 Bionic, chip paling cepat di ponsel pintar, untuk performa menakjubkan dalam aplikasi, game, dan fotografi. Mode Potret untuk potret kualitas studio dan enam efek pencahayaan.</p>
							<br>
							...
							<table style="width:200%">
								  <tr>
									<td>Tipe Layar</td>
									<td>Layar Retina HD</td>
								  </tr>
									  <tr>
										<td></td>
										<td>Layar lebar LCD Multi-Touch 4,7 inci (diagonal) dengan teknologi IPS</td>
									  </tr>
										  <tr>
											<td></td>
											<td>Resolusi 1334 x 750 piksel pada 326 ppi</td>
										  </tr>
											  <tr>
												<td></td>
																			...
																			<table style="width:139%">
																				  ...
																				  <table style="width:115%">
																					...
																					<td>Touch ID</td>
																						...
																						<tr>
																					<td></td>
																					<td>Sensor sidik jari generasi kedua terpasang di tombol Home</td>
																				  </tr>
																				</table>
																				<hr><br>
																				...
																				<table style="width:195%">
																					...
																					<td>Dengan waktu pakai yang serupa dengan iPhone 8</td>
																				  </tr>
																						<tr>
																						<td></td>
																						<td>Baterai lithium-ion bawaan yang dapat diisi ulang</td>
																							...
																							<td></td>
																							<td>Pemutaran video: hingga 13 jam</td>
																							</tr><tr>
																							<td></td>
																							<td>Pemutaran video (streaming): hingga 8 jam</td>
																							</tr><tr>
																							<td></td>
																							<td>Pemutaran audio: hingga 40 jam</td>
																							</tr><tr>
																							<td></td>
																							<td>Kemampuan isi daya cepat</td>
																							</tr><tr>
																							<td></td>
																							<td>Pengisian daya hingga 50% dalam 30 menit9 dengan adaptor 18 W atau lebih tinggi (dijual secara terpisah)</td>
																							</tr>
																				  </table>
																				  <hr><br>
