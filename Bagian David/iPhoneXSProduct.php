...
if(isset($_GET['logout'])) {
		...
		header('location: iPhoneXSProduct.php');
}
		...
		<div class="row">
			...
			<h4 id="demo">Rp. 16.999.000</h4>
				...
				<select id="mySelect" onchange="myFunction()">
					...
					<option value="19.999.000">256 GB</option>
					<option value="23.999.000">512 GB</option>
				</select>
				...
				<br>
							...
							<a href="../Bagian David/Keranjang Belanja/keranjangbelanjaiPhoneXS.php" class="btn-cart">Beli</a>
							<br><br>
							<h3>Detail Produk</h3>
...
<script>
function changeGold() {
ProductImg.src = "Gallery/iPhone/iPhone XS/iphone-xs-gold.png";
}

function changeSilver() {
ProductImg.src = "Gallery/iPhone/iPhone XS/iphone-xs-silver.png";
}

function changeSpaceGrey() {
ProductImg.src = "Gallery/iPhone/iPhone XS/iphone-xs-space-gray.png";
}
</script>
