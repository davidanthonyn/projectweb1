...
if(isset($_GET['logout'])) {
		...
		header('location: ../Bagian David/androidproducts.php');
}
...
<!-----featured products------>
<h2 style="text-align: center;">Android Products</h2>
<hr>
<div class="small-container">
<div class="row">
	<?php
							//SQL All Products Published
							$sql = "SELECT Nama_Produk,Harga_Produk,image,Storage,Warna FROM produk WHERE Status_Produk='Published' AND Jenis_Produk='Smartphone' AND Brand='Xiaomi' AND Brand='Samsung' AND Brand='Realme'";
