...
<!-----featured products------>
<h2 style="text-align: center;">iPhone 11 Products</h2>
<hr>
<div class="small-container">
<div class="row">
	<?php
							//SQL All Products Published
							$sql = "SELECT Nama_Produk,Harga_Produk,image,Storage,Warna,Stok_Produk FROM produk WHERE Nama_Produk='iPhone 11' AND Status_Produk='Published'";
