		...
		<div class="row">
			...
			<div class="col-2">
				<div class="form-container">
					...
					<form id="LoginForm">
						<input type="text" placeholder="Username" id="myUsernameLogin">
						<input type="password" placeholder="Password" id="myPasswordLogin">
						<button type="submit" class="btn-cart" onclick="loginAccount()">Login</button>
						<a href="../Bagian David/forgotpassword.php">Forgot Password</a>
					</form>
					
					<form id="RegForm">
						<input type="text" placeholder="Username" id="myUsernameReg">
						<input type="email" placeholder="Email" id="myEmailReg">
						<input type="password" placeholder="Password" id="myPasswordReg">
						<button type="submit" class="btn-cart" onclick="makeAccount()">Register</button>
					</form>
				</div>
			</div>
		</div>
...
<script>
	...
	function makeAccount() {
		if(usernameSignUp.value.length == "0" || emailSignUp.value.length == "0" || passwordSignUp.value.length == "0" ) {
