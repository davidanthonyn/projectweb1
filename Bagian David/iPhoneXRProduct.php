...
if(isset($_GET['logout'])) {
		...
		header('location: iPhoneXRProduct.php');
}
...
<p style="text-align:center; font-size: 15px; position: relative; left: -545px;">Home / iPhone XR</p>
<hr>
...
<!-----single product details------>
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="Gallery/iPhone/iPhone XR/iphone-xr-black.png" width="100%" id="ProductImg">
			</div>
			<div class="col-2">
			<h1>iPhone XR</h1>
			<h4 id="demo">Rp. 10.999.000</h4>
				<button class="btn" style="background-color: #48AEE6;" width="100%" onclick="changeBlue()"></button>
				<button class="btn" style="background-color: #FF6E5A;" width="100%" onclick="changeCoral()"></button>
				...
				<select id="mySelect" onchange="myFunction()">
					<option value="10.999.000">64 GB</option>
					<option value="11.999.000">128 GB</option>
					<option value="13.699.000">256 GB</option>
				</select>
				...
				<br>
							...
							<a href="../Bagian David/Keranjang Belanja/keranjangbelanjaiPhoneXR.php" class="btn-cart">Beli</a>
							<br><br>
							<h3>Detail Produk</h3>
							<p>Liquid Retina yang sepenuhnya baru - LCD tercanggih di industri ponsel. Face ID yang lebih cepat lagi. Chip paling cerdas dan Andal dalam ponsel pintar. Dan sebuah terobosan sistem kamera. iPhone Xr. Sangat mengagumkan dari sisi mana pun Anda melihatnya. Layar sepenuhnya yang membedakannya. Lihat betapa banyak ruang untuk melakukan semua yang Anda sukai.</p>
														...
														<td>Haptic Touch</td>
															...
															<hr><br>
																...
																<table style="width:116%">
																		...
																		<td>Level IP67 (kedalaman maksimum 1 meter hingga selama 30 menit) menurut standar IEC 60529</td>
																	  </tr>														
																</table>
																<hr><br>
																...
																<hr><br>
																		...
																		<tr>
																		<td>Kamera</td>
																		<td>Kamera 12 MP Wide</td>
																	  </tr>
																	  <tr>
																		<td></td>
																		<td>Lebar: bukaan ƒ/1.8</td>
																	  </tr>
																		  <tr>
																			<td></td>
																		  ...
																		  <tr>
																			  ...
																			  <tr>
																				...
																				<tr>
																				<td></td>
																				<td>Pencahayaan Potret dengan 3 efek (Alami, Studio, Kontur)</td>
																				</tr>
																					<tr>
																					<td></td>
																			...
																			<table style="width:139%">
																				...
																				<table style="width:136%">
																					...
																					<td>Dengan waktu pakai hingga 1,5 jam lebih lama dibanding iPhone 8 Plus</td>
																				  </tr>
																						<tr>
																						<td></td>
...
<script>
function changeBlue() {
ProductImg.src = "Gallery/iPhone/iPhone XR/iphone-xr-blue.png";
}

function changeCoral() {
ProductImg.src = "Gallery/iPhone/iPhone XR/iphone-xr-coral.png";
}

function changeWhite() {
ProductImg.src = "Gallery/iPhone/iPhone XR/iphone-xr-white.png";
}

function changeBlack() {
ProductImg.src = "Gallery/iPhone/iPhone XR/iphone-xr-black.png";
}

function changeRED() {
ProductImg.src = "Gallery/iPhone/iPhone XR/iphone-xr-red.png";
}

function changeYellow() {
ProductImg.src = "Gallery/iPhone/iPhone XR/iphone-xr-yellow.png";
}
</script>
