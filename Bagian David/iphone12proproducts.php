...
?>
  <title>iPhone 12 Pro | SI Gadget</title>
...
<div class="row">
	<?php
							...
							$sql = "SELECT Nama_Produk,Harga_Produk,image,Storage,Warna,Stok_Produk FROM produk WHERE Nama_Produk LIKE '%iPhone 12 Pro%' AND Status_Produk='Published'";
