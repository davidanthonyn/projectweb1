...
if(isset($_GET['logout'])) {
		...
		header('location: ../Bagian Sanctus/About.php');
}
...
.text-blue {
  ...
  <title>About Us | SI Gadget, Menjual Smartphone dan Aksesoris</title>
...
<p style="text-align:left; font-size: 15px; position: relative; left: 75px; z-index:-7;">Home / About</p>
<hr>
<!-- Ini Indikator penanda Halaman, supaya ga nyasar -->

<!--Judul -->
<div class="about-section animate__animated animate__fadeIn">
  <img class="animate__animated animate__fadeInLeft" src="smartphone.png" alt="" width="100px;">
  <h1 class="animate__animated animate__fadeInLeft" style="font-size:40px;">SI Gadget</h1>
  <p class="animate__animated animate__fadeInLeft" style="font-size:18px;">Kami adalah reseller gadget nomor satu di Indonesia, yang memegang teguh prinsip-prinsip kami kepada para pelanggan.<br>
    Kami selalu membuat para pelanggan percaya kepada produk kami karena murah, berkualitas, aman dan legal.</p>
</div>

<!--Our Founder -->
<div class="row">
<div class="column2" style="text-align:center;">
            <h3 class="text-center title animate__animated animate__fadeInLeft" style="font-size:40px; background: -webkit-linear-gradient(#000000, #590000);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;">
                Our Founder
            </h3>
            <div class="row">
                <div class="column">
                        <img src="david.jpg" class=" animate__animated animate__fadeInLeft" alt="" width="245px;">
                        <div class="text-team animate__animated animate__fadeInLeft">
                            <h1 class="fs-18 text-blue animate__animated animate__fadeIn">David Anthony</h1>
                              <br>
                          <p class="fs-14 text-dark animate__animated animate__fadeIn">Chief Executive Officer</p>

                    </div>
                </div>
				<div class="column">

                        <img src="sanctus.jpg" class="animate__animated animate__fadeInLeft" alt="" width="250px;">
                        <div class="text-team animate__animated animate__fadeInLeft">
                            <h1 class="fs-18 text-blue animate__animated animate__fadeIn">Bernardinus Sanctus</h1>
                            <br>
                            <p class="fs-14 text-dark animate__animated animate__fadeIn">IT Manager</p>
                            <p></p>
                ...
                <div class="column">
                    <div class="p-3">
                        <img src="tius.jpg" class=" animate__animated animate__fadeInLeft" alt="" width="251px;">
                        <div class="text-team animate__animated animate__fadeInLeft">
                            <h1 class="fs-18 text-blue animate__animated animate__fadeIn">Fransiskus Adventius</h1>
                            <br>
                            <p class="fs-14 text-dark animate__animated animate__fadeIn">Lead Computer Engineer</p>
                        </div>
                    </div>
                </div>
                <div class="column">
                ...
                <div class="column">
                        ...
                        <img src="migel.jpg" class=" animate__animated animate__fadeInLeft" alt="" width="240px;">
                        <div class="text-team animate__animated animate__fadeInLeft">
                            <h1 class="fs-18 text-blue animate__animated animate__fadeIn">Ignasius Migel</h1>
                              <br>
                            <p class="fs-14 text-dark animate__animated animate__fadeIn">Human Resource Department</p>
                        </div>
                    </div>
