...
if(isset($_GET['logout'])) {
		...
		header('location: ../Bagian Sanctus/selesai.php');
}
...
.text-blue {
  ...
  <title>Selesai | SI Gadget, Menjual Smartphone dan Aksesoris</title>
...
<p style="text-align:left; font-size: 15px; position: relative; left: 75px; z-index:-7;">Home / Cart / Pilih Kurir / Pilih Metode Pembayaran / Selesai</p>
<hr>
...
<div class="row">
  <div class="column2" style="text-align:center;">
    ...
    <img src="thankful.png" alt="" width="200px">
    ...
    <p style="font-size:20px; ; background: -webkit-linear-gradient(#000000, #590000);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
  }">Terima Kasih atas transaksi anda.
      Harap menunggu sampai pihak SIGadget menghubungi anda.</p>

      <span>Anda akan kembali ke menu utama</span>
