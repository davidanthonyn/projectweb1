...
if(isset($_GET['logout'])) {
		...
		header('location: ../Bagian Sanctus/eventpromo.php');
}
...
.text-blue {
  ...
  <title>Event & Promo | SI Gadget, Menjual Smartphone dan Aksesoris</title>
...
<p style="text-align:left; font-size: 15px; position: relative; left: 75px; z-index:-7;">Home / Event & Promo</p>
<hr>
<!-- Ini Indikator penanda Halaman, supaya ga nyasar -->

<div class="promo-section animate__animated animate__fadeIn">
  <div class="row">
    <div class="column1">
      <img src="galaxy.jpg" width="196px;"><br>
        <p>&nbsp;</p>
      <h2 style="background: -webkit-linear-gradient(#000000, #590000);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent; font-size:25px; text-align:center;">Samsung</h2>
      <a href="../Bagian Migel/samsungads.new.php"><input type="submit" name="" class="buttonblack" value="DETAIL"></a>
    </div>
    <div class="column1">
      <img src="iphone12.jpg" width="208px;"><br>
      <p>&nbsp;</p>
      <h2 style="background: -webkit-linear-gradient(#000000, #590000);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent; font-size:25px; text-align:center;">iPhone</h2>
      <a href="../Bagian David/iPhoneproducts.php"><input type="submit" name="" class="buttonblack" value="DETAIL"></a>
    </div>
    <div class="column1">
      <img src="accesories.jpg" width="230px;"><br>
      <p>&nbsp;</p>
      <h2 style="background: -webkit-linear-gradient(#000000, #590000);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent; font-size:25px; text-align:center;">Accesories</h2>
      <a href="../Bagian Tius/halamanaksesoris.php"><input type="submit" name="" class="buttonblack" value="DETAIL"></a>
    </div>
    <div class="column1">
      <img src="repairs.jpg" width="220px;"><br>
      <p>&nbsp;</p>
      <h2 style="background: -webkit-linear-gradient(#000000, #590000);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent; font-size:25px; text-align:center;">Repair</h2>
      <a href="repair.php"><input type="submit" name="" class="buttonblack" value="DETAIL"></a>
    </div>
    <div class="column2">
      <p>&nbsp;</p>
    </div>
